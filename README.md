...
A Java [Spring Boot](https://spring.io/projects/spring-boot) REST API exchanging data using the JSON format, allowing user to browse and create cooking recipes.
